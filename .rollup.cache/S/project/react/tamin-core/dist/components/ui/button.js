...
function Button(_a) {
    ...
    return (_jsx(Comp, Object.assign({ "data-slot": "button", className: cn(buttonVariants({ variant, size, className })), disabled: props.disabled || loading }, props, { children: loading ? (_jsx(Loader2, { className: "animate-spin" })) : (_jsxs(_Fragment, { children: [startIcon, _jsx("span", { children: props.children }), endIcon] })) })));
}
